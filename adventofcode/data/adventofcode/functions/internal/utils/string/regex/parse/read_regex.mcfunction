...
return run execute if data storage adventofcode:string/regex current.parse{current_char: "*"} run function adventofcode:internal/utils/string/regex/parse/types/quantifier
