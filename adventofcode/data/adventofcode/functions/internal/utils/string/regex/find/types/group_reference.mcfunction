...
data modify storage adventofcode:string/regex call.first set from storage adventofcode:string/regex current.find.stack[-1].tokens_stack[-1][0].end
data modify storage adventofcode:string/regex call.second set value 1
execute store result storage adventofcode:string/regex call.value int 1 run function adventofcode:internal/utils/operation/subtraction with storage adventofcode:string/regex call
