...
$execute store result storage adventofcode:global result int 1 run function adventofcode:internal/utils/compare/match {value: $(value), start: $(comparison), end: $(comparison)}
